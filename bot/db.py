...
INDEX_STATEMENTS = (
    ...
    "CREATE INDEX IF NOT EXISTS idx_cases_shk ON cases(shk)",
    "CREATE INDEX IF NOT EXISTS idx_cases_tare_transfer ON cases(tare_transfer)",
...
def find_case_candidates_by_shk(
    ...
    return _find_cases_by_field(
        ...
        case_expression="c.shk = ?",
        item_expression="ci.shk = ?",
        limit=limit,
        connection=connection,
        db_path=db_path,
    )
...
def find_case_candidates_by_tare_transfer(
    ...
    return _find_cases_by_field(
        ...
        case_expression="c.tare_transfer = ?",
        item_expression="ci.tare_transfer = ?",
        limit=limit,
        connection=connection,
        db_path=db_path,
    )
